			...
			<div class="headen_form_blk">
				<form class="checkout__form" action="#"> 
					...
					<div class="checkout__form-file">
						<input type="file" name="file" onchange = 'fileloadname(event)' multiple="multiple" accept=".txt,image/*" id="input__file" class="checkout__form-input-file input"> 
						<label for="input__file" class="input__file-button">
							<span class="input__file-button-text file-path" id = "file-path-name">Файл с дизайном</span>
						</label>
					</div>
